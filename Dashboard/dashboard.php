...
<body>
    <section style="background-color: #F5F5F5;" class="container-fluid   vh-100 ">
        <div class="row h-100 ">
            <div class="col-2  h-100 bg-white d-flex flex-column justify-content-start gap-5 align-items-center py-5">
                <div class="  px-4 py-2 row mb-5">
                    <a href="../index.php" class="text-dark px-0 link-underline link-underline-opacity-0  fs-4 fw-medium"><i class="me-3  bi bi-box-arrow-in-right"></i>Go Back</a>
                </div>
                <div class="row">
                    <div class="col-12">
                ...
                <div class="row mt-5">
                    <div class="col-12 d-flex flex-column gap-3 mb-5">
                        <div class=" dashBtn  px-3 py-2  row ">
                        ...
                        if (!empty($userId)) {
                            ...
                            if ($result->num_rows > 0) {
                                ...
                                echo "  <div class=' dashBtn px-3 py-2 row'>
            ...
            <div class="col-10  px-3">
                ...
                <div class="row px-5 mt-5 d-flex align-items-center justify-content-between">
                    ...
                    <div class=" col-5">
                        <div class="row d-flex justify-content-end gap-3">
                            ...
                            <div class="col-1">
                                <button type="button" id="notificationBtn" class="notificationBtn border-0 fs-4 fw-medium text-dark"> <i class="bi bi-bell"></i></button>
                            </div>
                        </div>
                    </div>
                </div>
                <!-- Dash Home -->
                <div id="dashHome" style="background-color: #F5F5F5;" class="displayDash px-5 pb-5  h-auto  ">
                    <div class="row">
                        <div class="col-8">
                            <div class="row mt-5">
                                    ...
                                    <div class="row mt-2">
                                        ...
                                        while ($row = $result->fetch_assoc()) {
                                            ...
                                            foreach ($productIds as $productId) {
                                                $sql = "SELECT COUNT(DISTINCT o.user_id) AS buyer_count
                                               FROM orders o
                                        ...
                                        $amount = 0;
                                        $sql = "SELECT  (p.product_price*oi.quantity) AS total_amount FROM order_items oi INNER JOIN products p ON oi.product_id = p.product_id WHERE p.merchant_id = ? GROUP BY p.product_price;";
                                        $stmt = $config->prepare($sql);
                                        $stmt->bind_param("i", $userId);
                                        $stmt->execute();
                                        $result = $stmt->get_result();
                                        ...
                                        <div style="background-color: #F5F5F5;" class="col-12 p-4">
                                            <div class="row">
                                                <div class="col-6 bg-white d-flex flex-column justify-content-center align-items-center gap-2 py-5">
                                                    ...
                                                    <h5 class="fs-3 fw-medium"><?php echo $total; ?></h5>
                                                </div>
                            ...
                            <section class="row mt-5">
                                <div class="col-12">
                                    <h5 class="mb-3">Your Product</h5>
                                    <div class="row sellers-card ">
                                        <div class="row g-4 d-flex similar-card w-100 gap-3 overflow-x-scroll">
                                            <?php
                        ...
                        <div style="background-color: #F5F5F5;" class="col-4  px-5 py-4 mt-4">
                            ...
                            <div class="row ">
                                <div class="col-12 bg-white  py-3">
                                    ...
                                    include_once('../config.php');
                                    // echo $userId;
                                    $sql = "SELECT p.main_image_name, p.main_img_extension,p.category_name, p.product_name, (p.product_price*oi.quantity) AS total_amount FROM order_items oi INNER JOIN products p ON oi.product_id = p.product_id WHERE p.merchant_id = ? GROUP BY p.product_price ORDER BY total_amount DESC;";
                                    // echo $sql . "<br>";
                                    ...
                                    ?>
                                        <div style="border-bottom: 1px solid #D6DDEE;" class="mx-2 mt-2 row pb-3 ">
                                            ...
                                            <div class="col-3">
                                                <p class="mb-0 fw-medium fs-6">&#8377; <?php echo  $row['total_amount']; ?></p>
                                            </div>
                                        </div>
                                    <?php
                                    }
                ...
                <!-- profile Dash -->
                <div id="dashProfile" style="background-color: #F5F5F5;" class="displayDash col-10 px-5 pb-5 h-auto d-none">
                ...
                <!-- orders dash -->
                <div id="dashOrders" style="background-color: #F5F5F5;" class="displayDash col-12 px-5 pb-5 h-auto d-none">
                    <div class="row mt-5">
                        <?php
                        require_once "../config.php";
                        $sql = " SELECT COUNT(DISTINCT o.order_id) AS order_count, p.product_id FROM orders o INNER JOIN order_items oi ON o.order_id = oi.order_id INNER JOIN products p ON oi.product_id = p.product_id WHERE p.merchant_id = ? ";
                        $stmt = $config->prepare($sql);
                        $stmt->bind_param("s", $userId);
                        $stmt->execute();
                        $result = $stmt->get_result();
                        ...
                        <div class="cart-container mt-3">
                            <form action="" method="post">
                                ...
                                $productSql = "SELECT * FROM orders o INNER JOIN order_items oi ON o.order_id = oi.order_id INNER JOIN products p ON oi.product_id = p.product_id WHERE p.merchant_id = ? ";
                                ...
                                ?>
                                        ...
                                        <div style="border-bottom: 1px solid #0f6290" class="row text-secondary px-3 py-4 fw-medium d-flex gap-4 gap-lg-0 align-items-center">
                                            ...
                                            <div class="col-12 col-lg-2 d-flex d-lg-block align-items-center ">
                                                ...
                                                <p class="mb-0 fw-medium text-dark ms-2 ms-lg-0 text-center"><?php echo $productRow['email'];  ?></p>
                                            </div>
                                            <div class="col-12 col-lg-1 d-flex d-lg-block align-items-center ">
                                                <p class="mb-0 text-start d-lg-none">Amount:</p>
                                                <p class="mb-0 fw-medium text-dark ms-2 ms-lg-0 text-center"><?php echo $productRow['total_amount'];  ?></p>
                                            </div>
                                            <div class="col-12 col-lg-2 d-flex d-lg-block align-items-center ">
                                            ...
                                            <div class="col-12 col-lg-2 d-flex d-lg-flex justify-content-center align-items-center ">
                                                ...
                                                <p class="mb-0 fw-medium text-dark ms-2 w-50 ms-lg-0 text-center py-lg-2 <?php if ($productRow['confirmation'] == "completed") {
                                            ...
                                            <div class="col-12 col-lg-2 d-flex d-lg-block align-items-center justify-content-center">
                                                <div class="row">
                                                    <div class="col-12 d-flex justify-content-center">
                                                        <?php if ($productRow['confirmation'] == "completed") {
                                                            echo "<a class='link-underline link-underline-opacity-0 text-white btn btn-danger w-100' href='./denyorder.php?trackno=" . $productRow['tracking_no'] . " '>Deny</a>";
                                                        } else {
                                                            echo "<a class='link-underline link-underline-opacity-0 text-white btn btn-success w-100' href='./confirmorder.php?trackno=" . $productRow['tracking_no'] . " '>Confirm</a>";
                                                        } ?>
                                                    </div>
                ...
                <!-- products dash -->
                <div id="dashProducts" style="background-color: #F5F5F5;" class="displayDash col-12 px-5 pb-5 h-auto  d-none">
                    <div class="row mt-5">
                        <h3 class="mb-3">Your products</h3>

                        <?php
                        require_once "../config.php";
                        $sql = " SELECT COUNT(*) AS total_rows FROM products   WHERE `merchant_id` = ?";
                        $stmt = $config->prepare($sql);
                        $stmt->bind_param("s", $userId);
                        $stmt->execute();
                        $result = $stmt->get_result();
                            ...
                            ?>
                                    <div style="border-bottom: 1px solid #0f6290" class="row text-secondary px-3 py-4 fw-medium d-flex gap-4 gap-lg-0 align-items-center">
                                        ...
                                        <div class="col-4 col-lg-1">
                                            <img class="img-fluid shadow-sm" src="../uploads/<?php echo $row['main_image_name'] . '.' . $row['main_img_extension']; ?>" alt="" />
                                        </div>
                ...
                <!-- Blogs dash -->
                <div id="dashBlogs" style="background-color: #F5F5F5;" class="displayDash col-12 px-5 pb-5 h-auto  d-none">
                    <div class="row mt-5">
                ...
                <!-- MErchants dash -->
                <div id="dashsuperAdmin" style="background-color: #F5F5F5;" class="displayDash col-12 px-5 pb-5 h-auto  d-none">
                    <div class="row mt-5">
                ...
                <!-- Admin dash -->
                <div id="dashAdmin" style="background-color: #F5F5F5;" class="displayDash col-12 px-5 pb-5 h-auto  d-none">
                    <div class="row mt-5">
                        <h3 class="mb-3">Merchants list</h3>
                        <?php
                        require_once "../config.php";
