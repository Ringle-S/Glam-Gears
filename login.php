...
<a class="fs-5 link-underline link-underline-opacity-0 fw-semibold px-5 text-end d-block d-flex align-items-center gap-0 justify-content-end" style="color: #0F6290;" href="./adminlogin.php">
    <i class="bi bi-arrow-right mt-5 me-4 fw-bold fs-4"></i>
    <p class="mt-5 me-4 mb-0">Switch To Admin Login</p>
</a>
