                            ...
                            <section class="row mt-5">
                                <div class="col-12">
                                    ...
                                    <div class="row sellers-card ">
                                        <div class="row g-3 d-flex similar-card w-100 gap-3 overflow-x-scroll">
                                            <?php
                                            ...
                                            ?>
                                                <form method="post" class=" col-12 col-md-6 col-lg-3  ">
                                                    <a href="./editproduct.php?id=<?php echo $row['product_id']; ?>" class="link-underline d-flex flex-column gap-1 justify-content-center link-underline-opacity-0 card-seller">
                                                        <div class="row">
                                                            <img height="220px" class=" object-fit-cover" src="../uploads/<?php echo $row['main_image_name'] . '.' . $row['main_img_extension']; ?>" alt="" />
                                                        </div>
                                                        <div class="row mt-2">
                        ...
                        <div style="background-color: #F5F5F5;" class="col-4  px-5 py-4 mt-4">
                            ...
                            <div class="row ">
                                <div class="col-12 bg-white  py-3">
                                    ...
                                    include_once('../config.php');
                                    // echo $userId;
                                    $sql = "SELECT p.main_image_name, p.main_img_extension,p.category_name, p.product_name, ((p.product_price*(1-p.discount_percent))*oi.quantity* COUNT(oi.product_id)) AS total_amount FROM order_items oi INNER JOIN products p ON oi.product_id = p.product_id WHERE p.merchant_id = ? AND p.product_status='active' GROUP BY p.product_price ORDER BY total_amount DESC;";
                                    // echo $sql . "<br>";
                    ...
                    <div class="row mt-5">
                        ...
                        <div class="cart-container mt-3">
                            <form action="" method="post">
                                ...
                                $productSql = "SELECT * FROM orders o INNER JOIN order_items oi ON o.order_id = oi.order_id INNER JOIN products p ON oi.product_id = p.product_id WHERE p.merchant_id = ? GROUP BY o.order_id ORDER BY o.created_at DESC";
